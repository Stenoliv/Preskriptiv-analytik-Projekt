...
| ----------------------------------- | ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| **Träna PPO-agent**                 | `python main.py train-ppo --timesteps 200000`                                       | Sparar modell till `models/ppo_carracing_v3.zip` som default och loggar till TensorBoard. |
...
Rapport finns i [report.md](report.md)